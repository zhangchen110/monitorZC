package com.flyusoft.common.dao.impl;
...
import com.flyusoft.common.dao.SimpleDao;
...
public class SimpleHibernateDaoImpl<T, PK extends Serializable> implements SimpleDao<T, PK> {
	...
	public void save(final T entity) {
		...
		if (entity instanceof IdEntity) {
			...
			if (identity.getId() != null && identity.getId().equals("")) {
				identity.setId(null);
			}
		}
