      ...
      return this.each(function() {
       ...
       //     complete:function(){Window.css('display', 'none'); }
        ...
        BTNClose.click(function () {
          ...
          var contextid = Window.parent().context.id;
          $('body').removeData(contextid);
          windowmap.remove(contextid);
          removeFromTaskList(contextid);
          return(false);          
        });
